...
def find_next_empty(puzzle):
    # finds the next row, col on the puzzle that's not filled yet (ie it has the value of -1)
...
def is_valid(puzzle, guess, row, col):
    ...
    # and then the square
    #divide by 3 but throw off the remainder
...
def solve_sudoku(puzzle):
    ...
    # step 1: choose somewhere on the puzzle to make a guess (ie the rth row and cth col must be empty)
